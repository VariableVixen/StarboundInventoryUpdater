1. Download [`Release.zip`](https://github.com/VariableVixen/StarboundInventoryUpdater/releases/latest/download/Release.zip) (unless you need to debug something) from the latest build
